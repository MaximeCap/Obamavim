...
--   event = "VimEnter",
--   config = function()
--     require("max.core.feline")
--   end,
--   dependencies = { "nvim-lua/lsp-status.nvim" },
-- }-- progress data
local clients = { "graphql", "docker_compose_language_service", "dockerls", "html", "yamlls", "tailwindcss", "cssls",
    "tsserver", "pyright", "lua_ls", "emmet_ls", "prismals", "astro" }
local progress = { '⠋', '⠙', '⠸', '⢰', '⣠', '⣄', '⡆', '⠇' }
    ...
    local c = {
        ...
        vim_status = {
            ...
            right_sep = {
                ...
                hl = { fg = palette.blue.base, bg = palette.blue.base },
            },
        },
        ...
        file_name = {
            ...
            left_sep = {
                ...
                hl = { fg = palette.blue.base, bg = palette.white.base },
            },
        },
        ...
        git_branch = {
            ...
            right_sep = {
                always_visible = true,
                str = separators.slant_right,
                hl = { fg = palette.fg3, bg = palette.fg3 },
            },
        },
        ...
        lsp = {
            ...
            left_sep = {
                ...
                hl = function()
                    ...
                    return { fg = palette.green.base, bg = palette.green.base }
                end,
            },
            right_sep = {
                always_visible = true,
