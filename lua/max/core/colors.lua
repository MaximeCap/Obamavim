...
M.gen_highlights = function()
  ...
  local groups = {
    ...
    -- Diagnostics
    FlnHint = { fg = sbg, bg = sfg, style = "bold" },
    FlnInfo = { fg = c.red, bg = sfg, style = "bold" },
    FlnWarn = { fg = sbg, bg = sfg, style = "bold" },
    FlnError = { fg = c.err, bg = sfg, style = "bold" },
    FlnStatus = { fg = sbg, bg = sfg, style = "bold" },
